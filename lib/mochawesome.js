        ...
        try {
            if (!endCalled) {
                ...
                var obj = {
                    ...
                    browser: codeceptjsConf.helpers.WebDriverIO.browser,
                    windowSize: codeceptjsConf.helpers.WebDriverIO.windowSize,
                    baseUrl: codeceptjsConf.helpers.WebDriverIO.url
                };
...
function cleanTest(test) {
    ...
    if ("err" in test) {
        if ("template" in test.err) {
            ...
            detailed = detailed.replace(/[\u001b\u009b][[()#;?]*(?:[0-9]{1,4}(?:;[0-9]{0,4})*)?[0-9A-ORZcf-nqry=><]/g, "");

            if ((test.err.params.type.indexOf("to be seen") > -1) || (test.err.params.type.indexOf("to include")) {
