  ...
  runner.on('end', function () {
    try {
      if (!endCalled) {
        ...
        var totalTestsRegisteredWithoutSkipped = totalTestsRegistered - obj.stats.skipped

        var passPercentage = Math.round((obj.stats.passes / (totalTestsRegisteredWithoutSkipped - obj.stats.pending))*1000)/10;
        var pendingPercentage = Math.round((obj.stats.pending / (totalTestsRegisteredWithoutSkipped))*1000)/10;
