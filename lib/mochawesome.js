  ...
  runner.on('end', function () {
    try {
      if (!endCalled) {
        ...
        obj.stats.testsRegistered = totalTestsRegistered - obj.stats.skipped;

        var passPercentage = Math.round((obj.stats.passes / (totalTestsRegistered - obj.stats.pending - obj.stats.skipped))*1000)/10;
        var pendingPercentage = Math.round((obj.stats.pending / (totalTestsRegistered - obj.stats.skipped))*1000)/10;
        ...
        obj.stats.skipped = totalTestsRegistered - obj.stats.tests;
...
//      {{customMessage}}expected {{jar}} {{type}} {{needle}}
      ...
      if (test.err.params.type.indexOf("to be seen") > -1) {
    ...
    if (err.message.indexOf("misMatchPercentage") > -1) {
      ...
      err.screenshot = test.title.replace(/ /g, '_') + '.failed.png'
    }
  }
