...
function initHandlebarsHelpers () {
  ...
  handlebars.registerHelper('formatDuration', function (context) {
    ...
    if (dur.hrs  < 1) {
      ...
      return dur.duration.get('m') + 'm:' + dur.duration.get('s') + ':' + dur.duration.get('ms');
    }
    return dur.duration.get('h') + 'h:' + dur.duration.get('m') + 'm:' + dur.duration.get('s') + ':' + dur.duration.get('ms');
  });
