...
config.clientJsFiles =  [path.join(config.nodeModulesDir, 'jquery', 'dist', 'jquery.js'),
                         path.join(config.bsDir, 'dist', 'js', 'bootstrap.js'),
                         path.join(config.nodeModulesDir, 'chart.js', 'Chart.js'),
                         path.join(config.srcJsDir, 'mochawesome.js')];
