...
// FontAwesome Directories
config.faDir          = path.join(config.nodeModulesDir, 'font-awesome');
config.faFontsDir     = path.join(config.faDir, 'fonts');
config.faLessDir      = path.join(config.faDir, 'less');
